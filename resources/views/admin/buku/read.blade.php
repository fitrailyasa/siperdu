                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('judul') is-invalid @enderror"
                                placeholder="Judul" name="judul" id="judul" value="{{ $buku->judul ?? '-' }}"
                                disabled>
                            @error('judul')
                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <input type="date" class="form-control @error('tanggal') is-invalid @enderror"
                                placeholder="Tanggal" name="tanggal" id="tanggal" value="{{ $buku->tanggal ?? '-' }}"
                                disabled>
                            @error('tanggal')
                                <div class="alert alert-danger">{{ $message }}</div>
                            @enderror
                ...
                <div class="row">
                    {{-- <div class="col-md-4">
                        <div class="mb-3">
                            ...
                            <img class="img img-fluid" src="{{ asset('assets/images/' . $buku->sampul) }}" alt="">
                            @error('sampul')
                                <div class="alert alert-danger">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('penulis') is-invalid @enderror"
                                placeholder="Penulis" name="penulis" id="penulis" value="{{ $buku->penulis ?? '-' }}"
                                disabled>
                            @error('penulis')
                                <div class="alert alert-danger">{{ $message }}</div>
                            @enderror
                    ...
                    <div class="col-md-4">
                        <div class="mb-3">
                            ...
                            <input type="number" class="form-control @error('stok') is-invalid @enderror"
                                placeholder="Stok" name="stok" id="stok" value="{{ $buku->stok ?? '-' }}"
                                disabled>
                            @error('stok')
                                <div class="alert alert-danger">{{ $message }}</div>
                            @enderror
                    ...
                    <div class="col-md-4">
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('ddc') is-invalid @enderror"
                                placeholder="DDC" name="ddc" id="ddc" value="{{ $buku->ddc ?? '-' }}"
                                disabled>
                            @error('ddc')
                                <div class="alert alert-danger">{{ $message }}</div>
                            @enderror
                    ...
                    <div class="col-md-4">
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('isbn') is-invalid @enderror"
                                placeholder="ISBN" name="isbn" id="isbn" value="{{ $buku->isbn ?? '-' }}"
                                disabled>
                            @error('isbn')
                                <div class="alert alert-danger">{{ $message }}</div>
                            @enderror
